...
internal static class ConfigCommand
{
    ...
    {
        var command = new Command("get", "Get a configuration setting. If no key is provided, all settings are returned.");

        var keyArg = new Argument<string?>(name: "key", description: "The key of the configuration setting", getDefaultValue: () => null);
